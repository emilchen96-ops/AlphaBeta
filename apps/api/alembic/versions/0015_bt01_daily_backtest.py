...
revision: str = "0015_bt01"
down_revision: str | None = "0014_d01"
...
def upgrade() -> None:
    op.create_index(
        "ix_market_bars_backtest_authority",
        "market_bars",
        [
            "source_id",
            "adjustment_type",
...
def downgrade() -> None:
    ...
    op.drop_index("ix_market_bars_backtest_authority", table_name="market_bars")
