...
class Settings(BaseSettings):
    ...
    miniqmt_history_download_timeout_seconds: float = Field(default=30.0, ge=5.0, le=600.0)
    miniqmt_quote_ttl_seconds: int = Field(default=300, ge=30, le=3600)
    scanner_worker_poll_ms: int = Field(default=1000, ge=100, le=60_000)
    scanner_worker_heartbeat_seconds: int = Field(default=5, ge=1, le=60)
    ...
    backtest_batch_data_retry_seconds: int = Field(default=20, ge=10, le=3_600)
