...
def test_upgrade_downgrade_reupgrade_and_check() -> None:
    ...
    assert "0018_d03" in current.stdout
    ...
    assert "0018_d03" in d03_reupgraded.stdout
    ...
    assert "0018_d03" in rt01_reupgraded.stdout
    ...
    assert "0018_d03" in bt01_reupgraded.stdout
    ...
    assert "0018_d03" in d01_reupgraded.stdout
    ...
    assert "0018_d03" in a01_reupgraded.stdout
    ...
    assert "0018_d03" in n01_reupgraded.stdout
    ...
    assert "0018_d03" in sc01_reupgraded.stdout
    ...
    assert "0018_d03" in reupgraded.stdout
