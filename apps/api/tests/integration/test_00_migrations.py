...
def test_upgrade_downgrade_reupgrade_and_check() -> None:
    ...
    assert "0029_bt_batches" in current.stdout
    ...
    assert "0029_bt_batches" in d03_reupgraded.stdout
    ...
    assert "0029_bt_batches" in rt01_reupgraded.stdout
    ...
    assert "0029_bt_batches" in bt01_reupgraded.stdout
    ...
    assert "0029_bt_batches" in d01_reupgraded.stdout
    ...
    assert "0029_bt_batches" in a01_reupgraded.stdout
    ...
    assert "0029_bt_batches" in n01_reupgraded.stdout
    ...
    assert "0029_bt_batches" in sc01_reupgraded.stdout
    ...
    assert "0029_bt_batches" in reupgraded.stdout
