...
def test_upgrade_downgrade_reupgrade_and_check() -> None:
    ...
    assert "0017_d02" in current.stdout
    ...
    assert "0017_d02" in rt01_reupgraded.stdout
    ...
    assert "0017_d02" in bt01_reupgraded.stdout
    ...
    assert "0017_d02" in d01_reupgraded.stdout
    ...
    assert "0017_d02" in a01_reupgraded.stdout
    ...
    assert "0017_d02" in n01_reupgraded.stdout
    ...
    assert "0017_d02" in sc01_reupgraded.stdout
    ...
    assert "0017_d02" in reupgraded.stdout
