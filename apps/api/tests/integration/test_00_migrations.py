...
def test_upgrade_downgrade_reupgrade_and_check() -> None:
    ...
    assert "0021_sc01r" in current.stdout
    ...
    assert "0021_sc01r" in d03_reupgraded.stdout
    ...
    assert "0021_sc01r" in rt01_reupgraded.stdout
    ...
    assert "0021_sc01r" in bt01_reupgraded.stdout
    ...
    assert "0021_sc01r" in d01_reupgraded.stdout
    ...
    assert "0021_sc01r" in a01_reupgraded.stdout
    ...
    assert "0021_sc01r" in n01_reupgraded.stdout
    ...
    assert "0021_sc01r" in sc01_reupgraded.stdout
    ...
    assert "0021_sc01r" in reupgraded.stdout
