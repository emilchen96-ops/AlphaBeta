...
def test_upgrade_downgrade_reupgrade_and_check() -> None:
    ...
    assert "0020_l25a" in current.stdout
    ...
    assert "0020_l25a" in d03_reupgraded.stdout
    ...
    assert "0020_l25a" in rt01_reupgraded.stdout
    ...
    assert "0020_l25a" in bt01_reupgraded.stdout
    ...
    assert "0020_l25a" in d01_reupgraded.stdout
    ...
    assert "0020_l25a" in a01_reupgraded.stdout
    ...
    assert "0020_l25a" in n01_reupgraded.stdout
    ...
    assert "0020_l25a" in sc01_reupgraded.stdout
    ...
    assert "0020_l25a" in reupgraded.stdout
