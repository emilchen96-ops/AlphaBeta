...
def test_upgrade_downgrade_reupgrade_and_check() -> None:
    ...
    assert "0033_bt03_portfolio" in current.stdout
    ...
    assert "0033_bt03_portfolio" in d03_reupgraded.stdout
    ...
    assert "0033_bt03_portfolio" in rt01_reupgraded.stdout
    ...
    assert "0033_bt03_portfolio" in bt01_reupgraded.stdout
    ...
    assert "0033_bt03_portfolio" in d01_reupgraded.stdout
    ...
    assert "0033_bt03_portfolio" in a01_reupgraded.stdout
    ...
    assert "0033_bt03_portfolio" in n01_reupgraded.stdout
    ...
    assert "0033_bt03_portfolio" in sc01_reupgraded.stdout
    ...
    assert "0033_bt03_portfolio" in reupgraded.stdout
