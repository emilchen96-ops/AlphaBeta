...
def test_upgrade_downgrade_reupgrade_and_check() -> None:
    ...
    assert "0022_ux02" in current.stdout
    ...
    assert "0022_ux02" in d03_reupgraded.stdout
    ...
    assert "0022_ux02" in rt01_reupgraded.stdout
    ...
    assert "0022_ux02" in bt01_reupgraded.stdout
    ...
    assert "0022_ux02" in d01_reupgraded.stdout
    ...
    assert "0022_ux02" in a01_reupgraded.stdout
    ...
    assert "0022_ux02" in n01_reupgraded.stdout
    ...
    assert "0022_ux02" in sc01_reupgraded.stdout
    ...
    assert "0022_ux02" in reupgraded.stdout
