...
const enumLabels: Record<string, string> = {
  ...
  SESSION_END: "交易日结束",
  NEXT_OPEN: "下一交易日开盘成交",
  SIGNAL_CLOSE_LIMIT: "信号日收盘限价撮合",
  SAME_DAY_NEXT_MINUTE: "当日尾盘判断、下一分钟成交",
...
const parameterLabels: Record<string, string> = {
  ...
  minimum_amount: "最低成交额",
  minimum_price: "最低股价",
  minimum_daily_return: "最低当日涨跌幅",
  maximum_daily_return: "最高当日涨跌幅",
  current_volume: "当前成交量",
  average_volume: "历史平均成交量",
  volume_ratio: "放量倍数",
  current_amount: "当前成交额",
  current_close: "当前收盘价",
  daily_return: "当日涨跌幅",
  limit_up_date: "最近涨停日期",
  limit_up_return: "涨停日涨幅",
  limit_up_close: "涨停日收盘价",
  baseline_price: "起涨基准价",
  distance_to_baseline: "距离基准价比例",
  days_since_limit_up: "距涨停交易日数",
  price_adjustment_mode: "价格模式",
  reference_price_type: "参考价格类型",
  factor_source: "复权因子来源",
  data_source: "数据来源",
  market_data_time: "MiniQMT数据时间",
